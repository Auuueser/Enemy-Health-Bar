...
public sealed class ConfigTexts
{
    public ConfigTexts(
        ...
        string diagnosticsSection,
        string layoutSection,
        string debugSection,
        string modDescription,
        string enabledName,
        string showWhenFullHealthName,
        string showInvulnerableEnemiesName,
        ...
        string barWidthName,
        string barHeightName,
        string worldScaleName,
        string displayModeName,
        string showHealthNumbersName,
        string healthTextFormatName,
        string showEnemyNameName,
        string sideBarWidthName,
        string sideBarHeightName,
        string sideBarHorizontalOffsetName,
        string debugEnabledName,
        ...
        string showInvulnerableEnemiesDescription,
        ...
        string barWidthDescription,
        string barHeightDescription,
        string worldScaleDescription,
        string displayModeDescription,
        string showHealthNumbersDescription,
        string healthTextFormatDescription,
        string showEnemyNameDescription,
        string sideBarWidthDescription,
        string sideBarHeightDescription,
        string sideBarHorizontalOffsetDescription,
